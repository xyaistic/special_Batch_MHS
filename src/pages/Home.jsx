...
export default function Home() {
  ...
  <a href="./cart">
  <button className=' font-bold btn-shop border-4 border-pink-400 bg-blue-500 rounded-lg w-60 h-10 mt-10 ml-20'>shop now ! </button>
  </a>
  ...
  <section className='mt-72 '>
    ...
    <div className='flex justify-between '>
      <h1 className='text-2xl font-bold flex  '>catogries</h1>
    {/* <Link to={`catogries`}><button>view more </button>  </Link> 
     */}
     <a href="catogries ">view more  </a>
    </div>
